    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Main open={open}>
        ...
        <Chip
          ...
          deleteIcon={
            <MonetizationOnIcon sx={{ color: blue[500], mr: 1, mt: 1 }} />
          }
          variant="outlined"
        />
        <Typography paragraph>
          ...
          <br />
          <EditLocationAltIcon sx={{ color: blue[500], mr: 1, mt: 1 }} /> Modify
          <MonetizationOnIcon sx={{ color: blue[500], mr: 1, mt: 1 }} /> Make
          Payment <br />
          <Divider />
          Past Rooms
          <br />
